...
#[Description('Apply validated semantic operations to a private draft. Requires expected_version, so concurrent agent or editor changes cannot be silently overwritten. Supported ops: set_form_values, add_block, update_block, remove_block, move_block.')]
#[IsOpenWorld(false)]
class PatchFormDraftTool extends Tool
{
