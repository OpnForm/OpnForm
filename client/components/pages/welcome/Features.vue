<template>
  <section id="features" class="px-8 lg:px-12">
    <div class="space-y-8 sm:space-y-12 mx-auto w-full max-w-336 lg:hidden">
      <div
    ...
    <div class="hidden lg:grid mx-auto w-full max-w-336 grid-cols-[minmax(0,1fr)_32rem] gap-16 xl:gap-24">
      <div class="space-y-24 xl:space-y-32 py-10 xl:py-16">
        <article
      ...
      <div class="relative py-10 xl:py-16">
        <div class="sticky top-10 xl:top-16 flex justify-center">
      ...
      >
        ...
        >
          ...
          <div class="relative flex justify-center lg:justify-end">
            ...
            >
              <div class="relative aspect-[1.67/1] overflow-hidden rounded-[18px] bg-white">
