...
## 2026-09-17 – Scoped admin API

Added a separate Sanctum admin API covering moderator operations except impersonation,
with explicit scopes, expiring operator-issued tokens, durable action receipts, idempotency,
preconditions and read-back verification. Existing public token abilities are unchanged.
See [Admin API](./admin/overview).
